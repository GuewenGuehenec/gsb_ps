...
public class Visiteur {
	...
	protected Visiteur responsable;
	
	public Visiteur(String matricule, String nom, String prenom, String login, String mdp, String adresse,
			Localite uneLocalite, String telephone, Date dateEntree, int prime, String codeUnite, String nomUnite, Visiteur unResponsable) {
		super();
	...
	public Visiteur getResponsable() {
		return responsable;
	}
	
	public void setResponsable(Visiteur unVisiteur) {
		this.responsable = unVisiteur;
	}
}
